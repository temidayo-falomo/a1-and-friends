        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-10 pt-24 pb-24">
          ...
          <div className="flex flex-col items-center justify-center min-h-[80vh] text-center space-y-8">
            <div className="space-y-6">
              <span className='inline-block font-["helvetica-extended"] font-[400] text-black text-[1.3125rem] bg-gradient-to-r from-amber-400 to-orange-400 px-4 py-2 rounded-full'>
                A1 & Friends
              </span>
